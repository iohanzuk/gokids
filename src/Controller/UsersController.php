...
class UsersController extends AppController
{
    ...
    public function view($id = null)
    {
        $user = $this->Users->get($id, [
            'contain' => ['UserTipos', 'Users', 'Avaliacaos', 'Caracteristicas', 'Categorias', 'EstabelecimentoCaracteristicas', 'Estabelecimentos']
        ]);
    ...
    public function add()
    {
        ...
        $userTipos = $this->Users->UserTipos->find('list', ['limit' => 200]);
        $this->set(compact('user', 'userTipos'));
        $this->set('_serialize', ['user']);
    }
