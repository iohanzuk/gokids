    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Sugestaos</h3>
          <div class="box-tools">
            ...
            <?php foreach ($sugestaos as $sugestao): ?>
              <tr>
                ...
                <td class="actions" style="white-space:nowrap">
                  ...
                  <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $sugestao->id], ['confirm' => __('Confirm to delete this entry?'), 'class'=>'btn btn-danger btn-xs']) ?>
                </td>
              </tr>
            <?php endforeach; ?>
            </tbody>
